...
namespace SpaceHaven_Save_Editor.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public void GotoGithub()
        {
            try
            {
                System.Diagnostics.Process.Start(new System.Diagnostics.ProcessStartInfo("https://github.com/Kazdell/SH-Save-Editor-Steam") { UseShellExecute = true });
            }
            catch (Exception ex)
            {
                UpdateLog("Could not open browser: " + ex.Message);
            }
        }
    }
}